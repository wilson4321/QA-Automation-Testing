...
Feature: Title of your feature
 ...
 Background:
    ...
    When Consulta el endpoint "endpoint Apiwil Post" por medio de peticion post.
      | id     |              102 |
      | name   | juan             |
  ...
  Scenario: Title of your scenario outline
    Given Dado que "actor" establece base url "Apiwil"
    When Consulta el endpoint deseado "endpoint Apiwil user" por medio de peticion get.
